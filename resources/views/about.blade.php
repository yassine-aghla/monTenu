...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-900 mb-4">À propos de Football Marketplace</h1>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">Votre destination premium pour les tenues de football authentiques</p>
        </div>
        ...
        <div class="flex flex-col lg:flex-row items-center mb-16">
            <div class="lg:w-1/2 mb-8 lg:mb-0 lg:pr-12">
                ...
                <p class="text-gray-700 mb-4">Fondé en 2015, Football Marketplace est né de la passion partagée pour le football et du désir de fournir aux fans des tenues authentiques de qualité.</p>
                <p class="text-gray-700 mb-4">Ce qui a commencé comme une petite boutique en ligne est rapidement devenu une référence dans le domaine des maillots de football, grâce à notre engagement envers l'authenticité, la qualité et le service client exceptionnel.</p>
                <p class="text-gray-700">Aujourd'hui, nous collaborons directement avec les plus grands clubs et fabricants pour vous offrir les dernières collections officielles.</p>
            </div>
            <div class="lg:w-1/2">
                <img src="{{ asset('storage/images/equipe.jpeg') }}" alt="Notre équipe" class="rounded-xl shadow-2xl w-full">
            </div>
        </div>

        <div class="bg-blue-50 rounded-xl p-8 mb-16">
            <h2 class="text-3xl font-bold text-gray-900 mb-6 text-center">Notre mission</h2>
            <p class="text-gray-700 text-center max-w-4xl mx-auto">Fournir aux fans de football du monde entier des tenues authentiques, de haute qualité, tout en offrant une expérience d'achat exceptionnelle. Nous nous engageons à promouvoir la passion du football à travers des produits officiels et un service client inégalé.</p>
        </div>
        ...
        <div class="mb-16">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md text-center">
                    ...
                    <p class="text-gray-700">Tous nos produits sont 100% authentiques, accompagnés de leurs certificats d'authenticité.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md text-center">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-gray-700">Nous partageons votre amour du football et nous nous engageons à servir la communauté des fans.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md text-center">
                    <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-gray-700">Notre équipe dévouée est là pour vous conseiller et répondre à toutes vos questions.</p>
                </div>
            </div>
        </div>

        <div class="text-center">
            <h2 class="text-3xl font-bold text-gray-900 mb-6">Rejoignez notre communauté</h2>
            <p class="text-gray-700 mb-8 max-w-2xl mx-auto">Plus de 100 000 fans de football nous font déjà confiance. Rejoignez-nous et faites partie de la famille Football Marketplace.</p>
            <a href="{{ route('shop.index') }}" class="inline-block bg-blue-800 text-white px-8 py-3 rounded-full font-bold hover:bg-blue-700 transition">
