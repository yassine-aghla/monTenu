...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('permissions.update', $permission->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" id="name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" value="{{ $permission->name }}" placeholder="Entrez le nom de la permission" required>
