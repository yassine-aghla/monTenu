...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="divide-y">
                    ...
                    <div class="p-6 flex flex-col md:flex-row">
                        ...
                        <div class="w-full md:w-3/4 md:pl-6">
                            ...
                            <p class="text-gray-600 mt-1">{{ $item->tenue->description }}</p>
                            ...
                            <div class="mt-4 grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium">{{ $item->tenue->taille }}</p>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-500">Couleur</p>
                                    <p class="font-medium">{{ $item->tenue->couleur }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="p-6 border-b">
                    <h2 class="text-xl font-semibold text-gray-800">Résumé de la commande</h2>
                </div>
