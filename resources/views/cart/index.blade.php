            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="md:col-span-2">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-4 flex flex-col md:flex-row">
                        <div class="w-full md:w-1/4 mb-4 md:mb-0">
                            <img src="{{ $item->tenue->images->first() ? asset('storage/'.$item->tenue->images->first()->image_path) : asset('images/placeholder.jpg') }}" alt="{{ $item->tenue->nom }}" class="w-full h-auto object-cover">
                        </div>
                ...
                <div class="md:col-span-1">
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <a href="{{ route('checkout.index') }}" class="mt-4 block w-full bg-blue-800 text-white text-center px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-300">
                            Passer la commande
                        </a>
                    </div>
                </div>
